class CoinBar extends DrawableObject {
  ...
  /**
   * Updates the number of collected coins and updates the image based on the current coin count.
   */
  setCoinNr(coinNr) {
    this.coinNr = coinNr;
  ...
  /**
   * Resolves the index of the image to display based on the current coin count.
   */
  resolveImageIndex() {
    if (this.coinNr == 10) {
      return 10;
